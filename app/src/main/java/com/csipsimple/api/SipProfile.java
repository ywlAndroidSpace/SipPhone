...
public class SipProfile implements Parcelable {
    ...
    public String getDefaultDomain() {
        SipUri.ParsedSipContactInfos parsedAoR = SipUri.parseSipContact(acc_id);
    ...
    public SipUri.ParsedSipContactInfos formatCalleeNumber(String fuzzyNumber) {
        SipUri.ParsedSipContactInfos finalCallee = SipUri.parseSipContact(fuzzyNumber);
