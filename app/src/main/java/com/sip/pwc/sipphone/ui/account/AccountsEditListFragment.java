...
package com.sip.pwc.sipphone.ui.account;
...
public class AccountsEditListFragment extends CSSListFragment implements /*OnQuitListener,*/ AccountsEditListAdapter.OnCheckedRowListener {
	...
	*/
	...
	@Override
	public void onToggleRow(AccountsEditListAdapter.AccountRowTag tag) {
		ContentValues cv = new ContentValues();
