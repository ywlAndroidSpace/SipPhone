...
public class CallTypeIconsView extends View {
    ...
    private static class Resources {
        ...
        public Resources(Context context, View v) {
            ...
            if(incoming == null) {
                incoming = r.getDrawable(R.mipmap.ic_call_incoming_holo_dark);
            }
            if(outgoing == null) {
                outgoing = r.getDrawable(R.mipmap.ic_call_outgoing_holo_dark);
            }
            if(missed == null) {
                missed = r.getDrawable(R.mipmap.ic_call_missed_holo_dark);
            }
            if(iconMargin == null) {
