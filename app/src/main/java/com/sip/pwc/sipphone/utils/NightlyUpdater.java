...
import com.sip.pwc.sipphone.service.DeviceStateReceiver;
import com.sip.pwc.sipphone.service.Downloader;
...
public class NightlyUpdater {
	...
	public class UpdaterPopupLauncher implements Runnable {
		...
		public void run() {
			...
			ab.setIcon(R.mipmap.ic_launcher_nightly)
				...
				ab.setMessage("Revision " + version + " available. Upgrade now?")
					.setPositiveButton(R.string.ok, new OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							it.putExtra(Downloader.EXTRA_ICON, R.mipmap.ic_launcher_nightly);
