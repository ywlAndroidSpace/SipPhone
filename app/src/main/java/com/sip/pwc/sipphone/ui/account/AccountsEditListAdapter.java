...
import com.sip.pwc.sipphone.utils.AccountListUtils;
...
public class AccountsEditListAdapter extends SimpleCursorAdapter implements OnClickListener {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (account.active) {
            AccountListUtils.AccountStatusDisplay accountStatusDisplay = AccountListUtils.getAccountDisplay(context,
                    account.id);
            ...
            tagView.barOnOff.setImageResource(R.mipmap.ic_indicator_off);

        }

        // Update account image
        final WizardUtils.WizardInfo wizardInfos = WizardUtils.getWizardClass(account.wizard);
        if (wizardInfos != null) {
