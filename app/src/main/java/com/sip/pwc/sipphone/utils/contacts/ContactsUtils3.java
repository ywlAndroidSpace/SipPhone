...
package com.sip.pwc.sipphone.utils.contacts;
...
public class ContactsUtils3 extends ContactsWrapper {
    ...
    public Bitmap getContactPhoto(Context ctxt, Uri uri, boolean hiRes, Integer defaultResource) {
        Bitmap img = null;
        try {
            img = People.loadContactPhoto(ctxt, uri, defaultResource != null ? defaultResource : R.mipmap.ic_contact_picture_holo_dark, null);
    ...
    public void bindContactPhoneView(View view, Context context, Cursor cursor) {
        ...
        Bitmap bitmap = getContactPhoto(context, uri, false, R.mipmap.ic_contact_picture_holo_dark);
