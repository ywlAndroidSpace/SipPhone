...
import com.sip.pwc.sipphone.ui.filters.AccountFilters;
import com.sip.pwc.sipphone.ui.prefs.GenericPrefs;
import com.sip.pwc.sipphone.utils.PreferencesWrapper;
import com.sip.pwc.sipphone.wizards.WizardUtils.WizardInfo;
...
public class BasePrefsWizard extends GenericPrefs {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		if (account.id != SipProfile.INVALID_ID) {
			...
			menu.add(Menu.NONE, FILTERS_MENU, Menu.NONE, R.string.filters).setIcon(R.mipmap.ic_menu_filter);
