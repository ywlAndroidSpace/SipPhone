...
package com.sip.pwc.sipphone.ui.calllog;
...
import com.sip.pwc.sipphone.models.CallerInfo;
import com.sip.pwc.sipphone.utils.ContactsAsyncHelper;
import com.sip.pwc.sipphone.utils.Log;
import com.sip.pwc.sipphone.utils.contacts.ContactsWrapper;
...
public class CallLogDetailsFragment extends SherlockFragment {
    ...
    private void updateData(final Uri... callUris) {
        ...
        if (contactUri != null) {
            ...
            mainActionIcon = R.mipmap.ic_contacts_holo_dark;
            ...
            mainActionIcon = R.mipmap.ic_add_contact_holo_dark;
    ...
    private void loadContactPhotos(Uri photoUri, Uri contactUri) {
        int defaultLargePhoto = R.mipmap.ic_contact_picture_180_holo_dark;
