...
public class PrefsLogic {
        ...
        switch (t) {
            case TYPE_MEDIA: {
                ...
                if(pfw.getPreferenceBooleanValue(SipConfigManager.USE_VIDEO)) {
                    ...
                    List<VideoUtilsWrapper.VideoCaptureDeviceInfo> capt = vuw.getVideoCaptureDevices(ctxt);
                    if(capt.size() == 0) {
    ...
    //                    }
            ...
            case TYPE_CALLS : {
                ...
                Map<String, ExtraPlugins.DynCodecInfos> videoPlugins = ExtraPlugins.getDynCodecPlugins(ctxt, SipManager.ACTION_GET_VIDEO_PLUGIN);
