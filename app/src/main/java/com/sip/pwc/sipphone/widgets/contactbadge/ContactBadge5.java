...
package com.sip.pwc.sipphone.widgets.contactbadge;
...
public class ContactBadge5 extends ContactBadgeContract {
    ...
    public ContactBadge5(Context context, AttributeSet attrs, int defStyle, com.sip.pwc.sipphone.widgets.contactbadge.QuickContactBadge topBadge) {
