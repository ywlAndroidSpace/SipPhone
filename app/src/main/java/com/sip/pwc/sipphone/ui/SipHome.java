...
package com.sip.pwc.sipphone.ui;
...
import com.sip.pwc.sipphone.ui.account.AccountsEditList;
import com.sip.pwc.sipphone.ui.calllog.CallLogListFragment;
import com.sip.pwc.sipphone.ui.dialpad.DialerFragment;
import com.sip.pwc.sipphone.ui.warnings.WarningFragment;
import com.sip.pwc.sipphone.ui.warnings.WarningUtils;
...
import com.sip.pwc.sipphone.utils.NightlyUpdater;
...
import com.sip.pwc.sipphone.utils.UriUtils;
...
//                    .setIcon(R.mipmap.ic_ab_favourites_holo_dark);
//        }
...
//                    .setIcon(R.mipmap.ic_ab_text_holo_dark);
//        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (CustomDistribution.distributionWantsOtherAccounts()) {
            ...
            menu.add(Menu.NONE, ACCOUNTS_MENU, Menu.NONE,
                    ...
                    .setIcon(R.mipmap.ic_menu_account_list)
        ...
        menu.add(Menu.NONE, CLOSE_MENU, Menu.NONE, R.string.menu_disconnect)
                .setIcon(R.mipmap.ic_lock_power_off)
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);
