...
package com.sip.pwc.sipphone.ui.prefs;
...
public class Codecs extends SherlockFragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        if(useCodecsPerSpeed) {
            Tab audioNb = ab.newTab().setText( R.string.slow ).setIcon(R.mipmap.ic_prefs_media);
            Tab audioWb = ab.newTab().setText( R.string.fast ).setIcon(R.mipmap.ic_prefs_media);
            tabAdapter.addTab(audioWb, CodecsFragment.class);
            tabAdapter.addTab(audioNb, CodecsFragment.class);
            if(showVideoCodecs) {
                Tab videoNb = ab.newTab().setText( R.string.slow ).setIcon(R.mipmap.ic_prefs_media_video);
                Tab videoWb = ab.newTab().setText( R.string.fast ).setIcon(R.mipmap.ic_prefs_media_video);
                
                tabAdapter.addTab(videoWb, CodecsFragment.class);
                tabAdapter.addTab(videoNb, CodecsFragment.class);
            }
        }else {
            Tab audioTab = ab.newTab().setIcon(R.mipmap.ic_prefs_media);
            tabAdapter.addTab(audioTab, CodecsFragment.class);
            
            if(showVideoCodecs) {
                Tab videoTab = ab.newTab().setIcon(R.mipmap.ic_prefs_media_video);
