...
package com.sip.pwc.sipphone.ui.filters;
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        switch (filter.action) {
            case Filter.ACTION_CAN_CALL:
                icon.setImageResource(R.mipmap.ic_menu_goto);
                break;
            case Filter.ACTION_CANT_CALL:
                icon.setImageResource(R.mipmap.ic_menu_blocked_user);
                break;
            case Filter.ACTION_REPLACE:
                icon.setImageResource(android.R.drawable.ic_menu_edit);
                break;
            case Filter.ACTION_DIRECTLY_CALL:
                icon.setImageResource(R.mipmap.ic_menu_answer_call);
                break;
            case Filter.ACTION_AUTO_ANSWER:
                icon.setImageResource(R.mipmap.ic_menu_auto_answer);
                break;
            default:
                break;
        }
