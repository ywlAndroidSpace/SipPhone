...
package com.sip.pwc.sipphone.ui.incall.locker.slidingtab;
...
import com.sip.pwc.sipphone.ui.incall.locker.IOnLeftRightChoice;
import com.sip.pwc.sipphone.ui.incall.locker.LeftRightChooserUtils;
...
public class SlidingTab extends ViewGroup implements IOnLeftRightChoice.IOnLeftRightProvider {
	...
	public SlidingTab(Context context, AttributeSet attrs) {
		...
		leftSlider = new Slider(this, R.mipmap.ic_jog_dial_answer, R.mipmap.jog_tab_target_green, R.drawable.jog_tab_bar_left_answer, R.drawable.jog_tab_left_answer);
		rightSlider = new Slider(this, R.mipmap.ic_jog_dial_decline, R.mipmap.jog_tab_target_red, R.drawable.jog_tab_bar_right_decline, R.drawable.jog_tab_right_decline);
	}
    ...
    public void setTypeOfLock(IOnLeftRightChoice.TypeOfLock lock) {
        ...
        if(lock == IOnLeftRightChoice.TypeOfLock.CALL) {
            ...
            // To sliding tab
            setLeftTabDrawables(getContext().getResources().getDrawable(R.mipmap.ic_jog_dial_answer),
                    getContext().getResources().getDrawable(R.mipmap.jog_tab_target_green),
            ...
            setRightTabDrawables(
                    getContext().getResources().getDrawable(R.mipmap.ic_jog_dial_decline),
                    getContext().getResources().getDrawable(R.mipmap.jog_tab_target_red),
