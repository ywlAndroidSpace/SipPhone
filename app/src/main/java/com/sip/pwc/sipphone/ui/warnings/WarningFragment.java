...
package com.sip.pwc.sipphone.ui.warnings;
...
public class WarningFragment extends SherlockFragment implements WarningUtils.OnWarningChanged {
    ...
    private void bindView() {
        if(viewContainer != null) {
            ...
            for(String warn : warnList) {
                ...
                WarningUtils.WarningBlockView v = WarningUtils.getViewForWarning(getActivity(), warn);
                if(v != null) {
     ...
     */
    public void setOnWarningChangedListener(WarningUtils.OnWarningChanged onWChangedListener) {
